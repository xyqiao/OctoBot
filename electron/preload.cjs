...
contextBridge.exposeInMainWorld("desktopApi", {
  ...
  listEnabledSkills: () => ipcRenderer.invoke("skill:listEnabled"),
  getSkillById: (id) => ipcRenderer.invoke("skill:get", id),
  ...
  refreshSkillsCatalog: () => ipcRenderer.invoke("skill:refresh"),
